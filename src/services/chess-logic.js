...
export class ChessLogic {
  ...
  initializeBoard() {
    return [
      // black row 1
      { name: "Rook", type: "R", x: 0, y: 0, color: "black" },
      { name: "Knight", type: "N", x: 0, y: 1, color: "black" },
      { name: "Bishop", type: "B", x: 0, y: 2, color: "black" },
      { name: "Queen", type: "Q", x: 0, y: 3, color: "black" },
      { name: "King", type: "K", x: 0, y: 4, color: "black" },
      { name: "Bishop", type: "B", x: 0, y: 5, color: "black" },
      { name: "Knight", type: "N", x: 0, y: 6, color: "black" },
      { name: "Rook", type: "R", x: 0, y: 7, color: "black" },
      // black row 2
      { name: "Pawn", type: "P", x: 1, y: 0, color: "black" },
      { name: "Pawn", type: "P", x: 1, y: 1, color: "black" },
      { name: "Pawn", type: "P", x: 1, y: 2, color: "black" },
      { name: "Pawn", type: "P", x: 1, y: 3, color: "black" },
      { name: "Pawn", type: "P", x: 1, y: 4, color: "black" },
      { name: "Pawn", type: "P", x: 1, y: 5, color: "black" },
      { name: "Pawn", type: "P", x: 1, y: 6, color: "black" },
      { name: "Pawn", type: "P", x: 1, y: 7, color: "black" },
      // white row 1
      { name: "Rook", type: "R", x: 7, y: 0, color: "white" },
      { name: "Knight", type: "N", x: 7, y: 1, color: "white" },
      { name: "Bishop", type: "B", x: 7, y: 2, color: "white" },
      { name: "Queen", type: "Q", x: 7, y: 3, color: "white" },
      { name: "King", type: "K", x: 7, y: 4, color: "white" },
      { name: "Bishop", type: "B", x: 7, y: 5, color: "white" },
      { name: "Knight", type: "N", x: 7, y: 6, color: "white" },
      { name: "Rook", type: "R", x: 7, y: 7, color: "white" },
      // white row 2
      { name: "Pawn", type: "P", x: 6, y: 0, color: "white" },
      { name: "Pawn", type: "P", x: 6, y: 1, color: "white" },
      { name: "Pawn", type: "P", x: 6, y: 2, color: "white" },
      { name: "Pawn", type: "P", x: 6, y: 3, color: "white" },
      { name: "Pawn", type: "P", x: 6, y: 4, color: "white" },
      { name: "Pawn", type: "P", x: 6, y: 5, color: "white" },
      { name: "Pawn", type: "P", x: 6, y: 6, color: "white" },
      { name: "Pawn", type: "P", x: 6, y: 7, color: "white" },
    ];
  }
